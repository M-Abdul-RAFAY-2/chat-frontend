        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              customers through innovative messaging solutions that drive growth
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                At Podium Chat, we believe that every conversation has the
                potential to transform a business. Our mission is to empower
                organizations of all sizes with the tools they need to connect
                meaningfully with their customers.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                We've built our platform from the ground up to be intuitive,
                powerful, and scalable, ensuring that whether you're a small
                startup or a large enterprise, you have everything you need to
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                customers. Their success is our success, and we're committed to
                their growth.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                customer communication, always staying ahead of the curve with
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                We set high standards for ourselves and our products. Quality
                isn't just a goal—it's our commitment to every customer we
                serve.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Passionate about building tools that help businesses grow and
                succeed.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Leading our technical vision with expertise in scalable
                messaging systems.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Ensuring our platform delivers exceptional user experiences at
                every touchpoint.
              </p>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Be part of the future of customer communication. Start your free
            trial today.
          </p>
          <Link
            href="/register"
