...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        "bg-zinc-900 text-white transition-all duration-300 flex flex-col h-full",
        collapsed ? "w-0 overflow-hidden" : "w-64"
      )}
    >
      {/* Header - Fixed */}
      <div className="flex items-center justify-between p-4 border-b border-gray-700 bg-zinc-900 flex-shrink-0">
        <div
          className={cn(
